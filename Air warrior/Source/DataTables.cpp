...
std::vector<AircraftData> initializeAircraftData()
{
	...
	data[Aircraft::Eagle].speed = 350.f;
	...
	data[Aircraft::Avenger].speed = 90.f;
	...
	data[Aircraft::Avenger].directions.push_back(Direction(0.f, 50.f));
	data[Aircraft::Avenger].directions.push_back(Direction(+45.f, 50.f));
	data[Aircraft::Avenger].fireInterval = sf::seconds(2.5);
...
std::vector<ProjectileData> initializeProjectileData()
{
	...
	data[Projectile::EnemyBullet].speed = 350.f;
